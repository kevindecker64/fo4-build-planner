    ...
    perks: [
      {
        rank: 1,
        name: "Iron Fist",
        img: "https://i.imgur.com/udiVJX3.png",
        ranks: 5,
        ranked: [
          {
            rank: 1,
            level: 0,
            description:
              "Channel your chi to unleash devastating fury! Punching attacks now do 20% more damage.",
          },
          {
            rank: 2,
            level: 9,
          ...
          },
          {
            ...
            level: 31,
            description:
              "Attacks made with fists or weapons worn on the hands 80% more damage. Unarmed Power Attacks have an increased chance to cripple one of your opponent's limbs.",
          },
          {
            rank: 5,
            level: 46,
            description:
              "Attacks made with fists or weapons worn on the hands inflict 100% more damage. Criticals in V.A.T.S. will paralyse your opponents.",
          },
        ],
      },
      {
        rank: 2,
        name: "Big Leagues",
        img: "https://i.imgur.com/pXnGgLF.png",
        ranks: 5,
        ranked: [
          {
            rank: 1,
      ...
      },
      {
        rank: 3,
        name: "Armorer",
        img: "https://i.imgur.com/kYX32fe.png",
        ranks: 4,
        ranked: [
          {
            rank: 1,
      ...
      },
      {
        rank: 4,
        name: "Blacksmith",
        img: "https://i.imgur.com/8DPrXn3.png",
        ranks: 3,
        ranked: [
          {
            rank: 1,
      ...
      },
      {
        rank: 5,
        name: "Heavy Gunner",
        img: "https://i.imgur.com/jRBsS79.png",
        ranks: 5,
        ranked: [
          {
            rank: 1,
      ...
      },
      {
        rank: 6,
        name: "Strong Back",
        img: "https://i.imgur.com/6RxamMU.png",
        ranks: 5,
        ranked: [
          {
            rank: 1,
          ...
          },
          {
            ...
            level: 40,
            description:
              "When overencumbered, running costs 50% less action points.(Far Harbor DLC)",
          },
        ],
      },
      {
        rank: 7,
        name: "Steady Aim",
        img: "https://i.imgur.com/FRwbc1g.png",
        ranks: 3,
        ranked: [
          {
            rank: 1,
          ...
          },
          {
            ...
            level: 49,
            description:
              "Hip-fire accuracy is improved when firing any gun.(Nuka-World DLC)",
          },
        ],
      },
      {
        rank: 8,
        name: "Basher",
        img: "https://i.imgur.com/u7wFMeV.png",
        ranks: 4,
        ranked: [
          {
            rank: 1,
      ...
      },
      {
        rank: 9,
        name: "Rooted",
        img: "https://i.imgur.com/mmXy192.png",
        ranks: 3,
        ranked: [
          {
            rank: 1,
      ...
      },
      {
        rank: 10,
        name: "Pain Train",
        img: "https://i.imgur.com/ALQYfT4.png",
        ranks: 3,
        ranked: [
          {
            rank: 1,
      ...
      },
      {
        ...
        ranked: [
          ...
          },
          {
            ...
            level: 14,
            description:
              "Knowing their weaknesses lets you attack more efficiently. 5% increase to hit chance and damage dealt to VATS targets.(Nuka-World DLC)",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        ranked: [
          ...
          },
          {
            ...
            level: 37,
            description:
              "You have 30 extra health between the hours of 6:00 PM and 6:00 AM.(Far Harbor DLC)",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        ranked: [
          ...
          },
          {
            ...
            level: 35,
            description:
              "You now have +40 Radiation Resistance. (Far Harbor DLC)",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        ranked: [
          ...
          },
          {
            ...
            level: 50,
            description:
              "Rad damage will now begin to slowly heal, restoring health in the process. (Nuka-World DLC)",
          },
        ],
      },
      {
        ...
        ranked: [
          {
            ...
            level: 0,
            description:
              "Catch some rays! Gain +2 to Strength and Endurance between the hours of 6:00a.m. and 6:00p.m.",
          },
          {
            rank: 2,
            level: 27,
        ...
        ranked: [
          {
            ...
            level: 0,
            description:
              "You've mastered the art of the deal! Buying and selling prices at vendors are better.",
          },
          {
            rank: 2,
            level: 20,
            description:
              "Buying and selling prices of vendors are now much better.",
          },
          {
            rank: 3,
            level: 41,
      ...
      },
      {
        ...
        ranked: [
          ...
          },
          {
            ...
            level: 7,
            description:
              "Men/Women now suffer +10% damage in combat, and are even easier to persuade in dialogue. They are also easier to pacify with the Intimidation perk.",
          },
          {
            rank: 3,
            level: 16,
      ...
      },
      {
        ...
        ranked: [
          ...
          },
          {
            ...
            level: 50,
            description:
              "When adventuring without a companion, you have 25 more action points.(Far Harbor DLC)",
          },
        ],
      },
      {
        ...
        ranked: [
          ...
          },
          {
            ...
            level: 31,
            description:
              "When adventuring with your dog, you take 10% less damage. (Nuka-World DLC)",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        ranked: [
          ...
          },
          {
            ...
            level: 21,
            description:
              "When you successfully pacify a creature, you can incite it to attack.",
          },
          {
            rank: 3,
            level: 49,
        ...
        ranked: [
          {
            ...
            level: 0,
            description:
              "Is there a doctor in the house? Stimpaks restore 40% of lost Health, and RadAway removes 40% of radiation.",
          },
          {
            rank: 2,
            level: 18,
      ...
      },
      {
        ...
        ranked: [
          ...
          },
          {
            ...
            level: 40,
            description:
              "You get more from salvaging. Appears to only apply to uncommon components, i.e., those affected by the first level of the perk. (Far Harbor DLC)",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        ranked: [
          ...
          },
          {
            ...
            level: 5,
            description:
              "You are now 30% harder to detect while sneaking, and no longer trigger floor-based traps.",
          },
          {
            rank: 3,
            level: 12,
      ...
      },
      {
        ...
        ranked: [
          ...
          },
          {
            ...
            level: 38,
            description:
              "Your Action Points now regenerate 75% faster. (Far Harbor DLC)",
          },
        ],
      },
      {
        ...
        ranked: [
          {
            ...
            level: 0,
            description:
              "Trained as a shadow warrior, your ranged sneak attack do 2.5x normal damage and your melee attacks do 4x normal damage.",
          },
          {
            rank: 2,
            level: 16,
      ...
      },
      {
        ...
        ranked: [
          ...
          },
          {
            ...
            level: 40,
            description:
              "Quick and efficient. You gain 10 additional Action Points. (Nuka-World DLC)",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        ranked: [
          ...
          },
          {
            ...
            level: 49,
            description:
              "The Mysterious Stranger appears more often in V.A.T.S. When he kills an opponent, there is a high chance your Critical meter gets filled. (Nuka-World DLC)",
          },
        ],
      },
      {
        ...
        ranked: [
          ...
          },
          {
            ...
            level: 11,
            description:
              "You now randomly receive 5x XP from any action. The lower your Intelligence, the greater the chance.",
          },
          {
            rank: 3,
            level: 34,
            description:
              "Randomly receiving bonus XP from any action may trigger 3x XP for all kills for a short period of time. The lower your Intelligence, the greater the chance.",
          },
        ],
      },
      {
        ...
        ranked: [
          {
            ...
            level: 0,
            description:
              "You're a patient battlefield tactician, and can save a Critical Hit, to be used in V.A.T.S. when you need it most.",
          },
          {
            rank: 2,
            level: 17,
            description:
              "You can now save 2 Critical Hits, to be used in V.A.T.S. when you need them the most.",
          },
          {
            rank: 3,
            level: 43,
            description:
              "You can now save 3 Critical Hits, to be used in V.A.T.S. when you need them the most. Banking a Critical has a chance to save an additional Critical.",
          },
          {
            rank: 4,
            level: 50,
            description:
              "You can now save 4 Critical Hits, to be used in V.A.T.S. when you need them the most. (Far Harbor DLC)",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        ranked: [
          ...
          },
          {
            ...
            level: 13,
            description:
              "Each hit in V.A.T.S. now has an even better chance of filling your Critical meter.",
          },
          {
            rank: 3,
            level: 32,
            description:
              "Each hit in V.A.T.S. now has a very good chance of filling your Critical meter.",
          },
          {
            rank: 4,
            level: 48,
        ...
        ranked: [
          {
            ...
            level: 0,
            description:
              "What goes around comes around! Any enemy's ranged attacks will sometimes ricochet back and instantly kill them. The closer you are to death, the higher the chance.",
          },
          {
            rank: 2,
            level: 29,
